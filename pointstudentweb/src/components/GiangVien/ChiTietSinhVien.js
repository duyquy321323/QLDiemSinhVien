...
const ChiTietSinhVien = () => {
    ...
    async function handEdit(e){
        e.preventDefault();
        try{
            await AuthApis().put(endpoints["editDiem"], editDiemForm);
            setAllowEdit(false);
        } catch (e){
            console.error(e);
        }
                                ...
                                {DSDiem.map(c => {
                                    if (c.khoaMon === 0) {
                                        return (<tr key={c[5]}>
                                            ...
                                            <td>{c.tenMonHoc}</td>
                                            <td>{c.lopHoc}</td>
                                            {c.diemKT1 !== -1 ? <td>{allowEdit? <input step="0.01" type='number' onChange={handChange} name={`diemKT1 ${c.idMonHocDangKy}`} defaultValue={parseFloat(c.diemKT1).toFixed(2)}/> : parseFloat(c.diemKT1).toFixed(2)}</td> : <td>{allowEdit? <input step="0.01" type='number' onChange={handChange} name={`diemKT1 ${c.idMonHocDangKy}`}/> : "-"}</td>}
                                            {c.diemKT2 !== -1 ? <td>{allowEdit? <input step="0.01" type='number' onChange={handChange} name={`diemKT2 ${c.idMonHocDangKy}`} defaultValue={parseFloat(c.diemKT2).toFixed(2)}/> : parseFloat(c.diemKT2).toFixed(2)}</td> : <td>{allowEdit? <input step="0.01" type='number' onChange={handChange} name={`diemKT2 ${c.idMonHocDangKy}`}/> : "-"}</td>}
                                            {c.diemKT3 !== -1 ? <td>{allowEdit? <input step="0.01" type='number' onChange={handChange} name={`diemKT3 ${c.idMonHocDangKy}`} defaultValue={parseFloat(c.diemKT3).toFixed(2)}/> : parseFloat(c.diemKT3).toFixed(2)}</td> : <td>{allowEdit? <input step="0.01" type='number' onChange={handChange} name={`diemKT3 ${c.idMonHocDangKy}`}/> : "-"}</td>}
                                            {c.diemGK !== -1 ? <td>{allowEdit? <input step="0.01" type='number' onChange={handChange} name={`diemGK ${c.idMonHocDangKy}`} defaultValue={parseFloat(c.diemGK).toFixed(2)}/> : parseFloat(c.diemGK).toFixed(2)}</td> : <td>{allowEdit? <input step="0.01" type='number' onChange={handChange} name={`diemGK ${c.idMonHocDangKy}`}/> : "-"}</td>}
                                            {c.diemCK !== -1 ? <td>{allowEdit? <input step="0.01" type='number' onChange={handChange} name={`diemCK ${c.idMonHocDangKy}`} defaultValue={parseFloat(c.diemCK).toFixed(2)}/> : parseFloat(c.diemCK).toFixed(2)}</td> : <td>{allowEdit? <input step="0.01" type='number' onChange={handChange} name={`diemCK ${c.idMonHocDangKy}`}/> : "-"}</td>}
