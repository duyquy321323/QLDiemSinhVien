...
public class DienDanRepositoryImpl implements DienDanRepository {
    ...
    @Override
    public List<Traloidiendan> getTraLoiByTaiKhoan(String id) {
        Session s = this.factory.getObject().getCurrentSession();
        CriteriaBuilder b = s.getCriteriaBuilder();
    ...
    @Override
    public boolean deleteTraloiByTaiKhoan(String id) {
        Session s = this.factory.getObject().getCurrentSession();
    ...
    @Override
    public boolean deleteCauHoiByTaiKhoan(String id) {
        Session s = this.factory.getObject().getCurrentSession();
    ...
    @Override
    public List<Cauhoidiendang> getCauhoiByTaiKhoan(String id) {
        Session s = this.factory.getObject().getCurrentSession();
        CriteriaBuilder b = s.getCriteriaBuilder();
