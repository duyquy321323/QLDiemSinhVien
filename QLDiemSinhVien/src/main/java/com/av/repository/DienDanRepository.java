...
public interface DienDanRepository {
    ...
    List<Traloidiendan> getTraLoiByTaiKhoan(String id);
    boolean deleteTraloiByTaiKhoan(String id);
    List<Cauhoidiendang> getCauhoiByTaiKhoan(String id);
    boolean deleteCauHoiByTaiKhoan(String id);
}
