...
public class ApiMonHocController {
    ...
    @CrossOrigin
    public ResponseEntity<Monhoc> getMonHocHocKy(@RequestParam Integer idMonHocHocKy){
        return new ResponseEntity<>(this.mhService.getMonhocByIdMonhocHocKy(idMonHocHocKy), HttpStatus.OK);
    }
