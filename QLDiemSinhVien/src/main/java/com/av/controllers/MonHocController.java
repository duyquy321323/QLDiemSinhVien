...
public class MonHocController {
    ...
    public String add(@ModelAttribute(value = "monhocc") Monhoc mh) {
        mh.setTenMonHoc(Utils.decodeBase64(mh.getTenMonHoc()));
        if (this.mhService.addOrUpdateMonHoc(mh)) {
    ...
    private String decodeBase64(String encodedString) {
        ...
        try {
            ...
            System.out.println("Lỗi giải mã Base64: " + e.getMessage());
            return encodedString; // Nếu lỗi, trả về nguyên bản
        }
    }
}
