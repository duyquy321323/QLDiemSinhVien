...
public class SinhVienController {
    ...
    public String add(@ModelAttribute(value = "sinhvienn") @Valid Sinhvien sv, BindingResult rs) {
        if (!rs.hasErrors()) {
            sv.setHoTen(Utils.decodeBase64(sv.getHoTen()));
            sv.setDiaChi(Utils.decodeBase64(sv.getDiaChi()));
            sv.setSoDienThoai(Utils.decodeBase64(sv.getSoDienThoai()));
            sv.setEmail(Utils.decodeBase64(sv.getEmail()));
