...
<div class="row">
    <div class=" margin-auto form-login  form-addSV ">
        ...
        <div class="text-form-addSV">
            <form:form method="post" modelAttribute="sinhvienn" action="${action}" accept-charset="UTF-8">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        form.addEventListener("submit", function(event) {
            ...
            let soDienThoai = document.getElementById("phonenumber").value;
            let email = document.getElementById("email").value;

            // Mã hóa Base64
            hoTen = btoa(unescape(encodeURIComponent(hoTen)));
            diaChi = btoa(unescape(encodeURIComponent(diaChi)));
            soDienThoai = btoa(unescape(encodeURIComponent(soDienThoai)));
